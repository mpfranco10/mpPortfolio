...
function Education() {
  return (
    <div className="education" id="education">
      <p className="title">
        {" "}
        <span className="emoji" role="img" aria-label="graduationCapEmoji">
          🎓
        </span>
        Education
      </p>
      <div>
        <Bubble>
          ...
          <p>
            <strong>Univesidad de los Andes - Colombia</strong>
          </p>
          <p>
            <strong>Systems and Computational Engineer</strong>
          </p>
